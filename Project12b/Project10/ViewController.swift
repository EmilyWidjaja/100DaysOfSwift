...
//  Use codable - if don't care about objc compatibility & is better for reading json
...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {  //conforms to both protocols
    ...
    override func viewDidLoad() {
        ...
        if let savedPeople = defaults.object(forKey: "people") as? Data {
            ...
            do {
                people = try jsonDecoder.decode([Person].self, from: savedPeople)   //attempt to create array of Person objects
            } catch {
